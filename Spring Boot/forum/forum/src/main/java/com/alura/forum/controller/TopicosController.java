...
import com.alura.forum.controller.form.TopicoUpdateForm;
import com.alura.forum.controller.repository.CursoRepository;
...
public class TopicosController {
	...
	public ResponseEntity<TopicoDto> cadastrar(@RequestBody @Valid TopicoForm topicoform,
		...
		Topico topico = topicoform.coverte(cursoRepository);
	...
	@PutMapping("/{id}")
	@Transactional
	public ResponseEntity<TopicoDto> atualizar(@PathVariable Long id, @RequestBody @Valid TopicoUpdateForm topicoform) {
